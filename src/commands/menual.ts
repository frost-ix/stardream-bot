  ...
  async execute(interaction: Interaction) {
    ...
    await interaction.reply(
      "# 안녕하세요 ! 스타드림 봇 입니다." +
        ...
        "### X 링크 불러오기\n" +
        "- /링크 명령어로 스타드림 멤버들의 X(구 트위터) 링크를 안내합니다.\n\n" +
        "### X 스페이스 최근 3개 검색 링크 불러오기\n" +
        "- /x스페이스 명령어로 스타드림 멤버들의 최근 스페이스 3개를 검색합니다.\n\n" +
        "### 유튜브 / 네이버 카페 링크 불러오기\n" +
        "- /링크-카페_유튜브 명령어로 스타드림 멤버들의 유튜브 / 네이버 카페 링크를 안내합니다.\n\n" +
        "### 트윗캐스트 링크 불러오기\n" +
        "- /링크-트윗캐스트 명령어로 스타드림 멤버들의 트윗캐스트 링크를 안내합니다.\n\n"
    );
  },
};
